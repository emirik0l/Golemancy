...
public class ClayEffigyEntity extends TameableEntity{
	...
	protected void initGoals() {
		...
		this.goalSelector.add(6, new GolemMoveToItemGoal(this, 10.0F, new String[]{"Hungry"}));
		this.goalSelector.add(6, new GolemFollowOwnerGoal(this, 1.0D, 6.0F, 2.0F, 750.0F, false, new String[]{"Curious"}));
		this.goalSelector.add(8, new GolemWanderAroundFarGoal(this, 1.0D, new String[]{"Restless"}));
		this.goalSelector.add(10, new GolemLookAtEntityGoal(this, PlayerEntity.class, 8.0F, new String[]{"Restless", "Curious", "Hungry"}));
	}
