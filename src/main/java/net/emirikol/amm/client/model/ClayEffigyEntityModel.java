...
public class ClayEffigyEntityModel extends EntityModel<ClayEffigyEntity> {
	...
	public ClayEffigyEntityModel() {
		...
		base.setTextureOffset(0, 0).addCuboid(-4.0F, -12.0F, -3.0F, 7.0F, 7.0F, 7.0F); //body
		base.setTextureOffset(44, 54).addCuboid(-3.0F, -17.0F, -2.0F, 5.0F, 5.0F, 5.0F, 0.0F); //head
		base.setTextureOffset(0, 0).addCuboid(-3.0F, -12.0F, -5.0F, 5.0F, 9.0F, 2.0F); //arm
		base.setTextureOffset(0, 0).addCuboid(-3.0F, -12.0F, 4.0F, 5.0F, 9.0F, 2.0F); //arm
		base.setTextureOffset(0, 0).addCuboid(-4.0F, -5.0F, 0.0F, 7.0F, 5.0F, 4.0F); //leg
		base.setTextureOffset(0, 0).addCuboid(-4.0F, -5.0F, -3.0F, 7.0F, 5.0F, 3.0F); //leg
	}
