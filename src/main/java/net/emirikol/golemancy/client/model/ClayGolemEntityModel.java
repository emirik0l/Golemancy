...
public class ClayGolemEntityModel extends EntityModel<AbstractGolemEntity> implements ModelWithArms {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		modelPartData.addChild(EntityModelPartNames.BODY, ModelPartBuilder.create().uv(0, 40).cuboid(-9.0F, -10.0F, -5.5F, 18.0F, 12.0F, 11.0F).uv(0, 70).cuboid(-5.0F, 1.0F, -2.5F, 10.0F, 6.0F, 5.0F), ModelTransform.pivot(0.0F, 1.0F, 5.5F)); //Body contains two cuboids with separate textures, top and bottom
		modelPartData.addChild(EntityModelPartNames.HEAD, ModelPartBuilder.create().uv(0, 0).cuboid(-4.0F, -43.0F, 1.0F, 8.0F, 10.0F, 8.0F), ModelTransform.pivot(0.0F, 24.0F, 0.0F));
		modelPartData.addChild(EntityModelPartNames.LEFT_LEG, ModelPartBuilder.create().uv(37, 0).cuboid(-5.0F, -16.0F, 1.0F, 6.0F, 16.0F, 5.0F), ModelTransform.pivot(6.0F, 24.0F, 2.0F));
		modelPartData.addChild(EntityModelPartNames.RIGHT_LEG, ModelPartBuilder.create().uv(60, 0).cuboid(-8.0F, -16.0F, 3.0F, 6.0F, 16.0F, 5.0F), ModelTransform.pivot(0.0F, 24.0F, 0.0F));
		modelPartData.addChild(EntityModelPartNames.LEFT_ARM, ModelPartBuilder.create().uv(60, 58).cuboid(9.0F, -33.0F, 3.0F, 4.0F, 30.0F, 6.0F), ModelTransform.pivot(0.0F, 24.0F, 0.0F));
		modelPartData.addChild(EntityModelPartNames.RIGHT_ARM, ModelPartBuilder.create().uv(60, 21).cuboid(-13.0F, -33.0F, 3.0F, 4.0F, 30.0F, 6.0F), ModelTransform.pivot(0.0F, 24.0F, 0.0F));
