...
public class AbstractGolemEntityModel<T extends Entity> extends EntityModel<T> implements ModelWithArms {
	...
	public AbstractGolemEntityModel(ModelPart modelPart) {
